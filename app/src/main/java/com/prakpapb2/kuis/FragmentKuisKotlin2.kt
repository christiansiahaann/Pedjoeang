...
class FragmentKuisKotlin2 : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        answerList = bundle.getIntegerArrayList("answer")!!
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_kuis_kotlin2, container, false)
